    ...
    <div class="container sign_up_container" style="margin-top: 200px;">
        ...
        <div>
            ...
            <div class="row justify-content-center" v-if="userType=='local'">
                ...
                <div class="col sign_up_middle">
                    <input class="sign_up_input" type="text" placeholder="비밀번호를 입력하세요 (8자리 이상)" v-model="userPassword">
                </div>
                <div class="col sign_up_right">
                </div>
            </div>
            ...
            <div class="row justify-content-center" v-if="userType=='local'">
                ...
                <div class="col sign_up_middle">
                    <input class="sign_up_input" type="text" placeholder="비밀번호를 다시 입력하세요" v-model="userPassword2">
                </div>
                <div class="col sign_up_right">
                </div>
            </div>
